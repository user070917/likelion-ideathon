...
class AIService:
    ...
    async def generate_carebot_response(self, user_name: str, history: list = []):
        ...
        - 지침: 대화 중간에 "제가 오늘 밤에는 '노란 사과' 꿈을 꾸고 싶어요. 제가 무슨 꿈 꾸고 싶다고 했는지 이따가 다시 여쭤볼게요!"라는 식의 기억 단서를 자연스럽게 심으세요.

        단계 3: 언어 유창성 및 주의집중력 테스트 (MMSE 고변별 문항)
        - 지침: 주방 물건 3가지 말하기 혹은 숫자 거꾸로 말하기를 싹싹하게 부탁해 보세요.

        단계 4: 에피소드 지연 회상 (최종 인지 확인)
        - 지침: 아까 심은 단서(노란 사과)를 기억하시는지 확인하며 마무리하세요.
        ...
        {{
          "cognitive_assessment": {{
            ...
            "summary": {{
              "estimated_mmse": 0-30,
              "clinical_risk": "정상|경도인지장애의심|치매위험",
              "special_note": "상세 분석 내용"
            }}
          }},
          "tags": ["정상", "기억력저하", "언어유창성부족", "의사소통원활"]
        }}
